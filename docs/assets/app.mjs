...
export const repositoryPaths = [
  ...
  "plugins/codex-game-studios/docs/OFFICIAL_MIGRATION_AUDIT.md",
...
export const content = {
  en: {
    ...
    repositoryDescriptions: [
      ...
      "Official OpenAI migration audit and dispositions",
      "Validation and security report",
    ],
    version:
      "Current release: 0.1.1. Adapted from upstream commit 984023ddac0d5e27624f2baacde6105e45de375f and distributed under the MIT License.",
    copy: "Copy",
    copied: "Copied",
  ...
  "zh-CN": {
    ...
    repositoryDescriptions: ["Codex 插件市场清单", "完整插件包", "原项目到 Codex 的迁移映射", "OpenAI 官方迁移审计与处置说明", "验证与安全报告"],
    version:
      "当前版本：0.1.1。基于上游提交 984023ddac0d5e27624f2baacde6105e45de375f 完成适配，并使用 MIT License 分发。",
    copy: "复制",
    copied: "已复制",
    copyFailed: "复制失败",
  ...
  ru: {
    ...
    repositoryDescriptions: ["Манифест маркетплейса Codex", "Полный пакет плагина", "Карта переноса в Codex", "Официальный аудит миграции OpenAI и принятые решения", "Отчёт о проверке и безопасности"],
    version:
      "Текущая версия: 0.1.1. Адаптирована из commit 984023ddac0d5e27624f2baacde6105e45de375f и распространяется по лицензии MIT.",
    copy: "Копировать",
    copied: "Скопировано",
  ...
  de: {
    ...
    repositoryDescriptions: ["Codex-Marketplace-Manifest", "Vollständiges Plugin-Paket", "Zuordnung der Codex-Migration", "Offizielles OpenAI-Migrationsaudit und Entscheidungen", "Validierungs- und Sicherheitsbericht"],
    version:
      "Aktuelle Version: 0.1.1. Basierend auf Upstream-Commit 984023ddac0d5e27624f2baacde6105e45de375f und unter der MIT-Lizenz veröffentlicht.",
    copy: "Kopieren",
    copied: "Kopiert",
  ...
  ja: {
    ...
    repositoryDescriptions: ["Codex マーケットプレイスマニフェスト", "完全なプラグインパッケージ", "Codex への移行マッピング", "OpenAI 公式移行監査と対応方針", "検証およびセキュリティレポート"],
    version:
      "現在のバージョン：0.1.1。上流コミット 984023ddac0d5e27624f2baacde6105e45de375f を基に適応し、MIT License で配布しています。",
    copy: "コピー",
    copied: "コピーしました",
  ...
  ko: {
    ...
    repositoryDescriptions: ["Codex 마켓플레이스 매니페스트", "전체 플러그인 패키지", "Codex 마이그레이션 매핑", "OpenAI 공식 마이그레이션 감사 및 처리 방침", "검증 및 보안 보고서"],
    version:
      "현재 버전: 0.1.1. 업스트림 커밋 984023ddac0d5e27624f2baacde6105e45de375f를 기반으로 조정되었으며 MIT License로 배포됩니다.",
    copy: "복사",
    copied: "복사됨",
    copyFailed: "복사 실패",
